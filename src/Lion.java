 ...
 */
public class Lion extends Animal implements JumpWater{

    public Lion(boolean camp){

        super(camp);
        this.strength = 7;
        this.path = "File:animals/7Lion" + (camp ? "Left" : "Right") + ".png";
        this.name = "狮";
    ...
    public boolean checkCanMove(String[][] tileArray, Animal[][] animal, int x, int y, int xAfter, int yAfter) {
        ...
        if (Math.abs(xAfter - x) == 4 || Math.abs(yAfter - y) == 3){
