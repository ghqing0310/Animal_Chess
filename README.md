...
注：这个功能比较难深挖，所以取得高分可能有些困难，但拿到 4 分会比较容易。
...
Android 版为拓展功能，JavaFX 版本的斗兽棋必须实现。
...
较难。如果是通过手动输入 ip 的方式，还稍简单一些。但如果想实现像 [doushouqi.net](doushouqi.net) 这样的网络对战功能，难度过高，非常不推荐。
